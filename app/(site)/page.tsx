...
export default async function Home() {
    ...
    return (
        <div>
            <h1 className="font-semibold text-5xl">Hello I am <span className="bg-gradient-to-r from-orange-500 via-red-500 to-purple-600 bg-clip-text text-transparent">Recep</span></h1>
